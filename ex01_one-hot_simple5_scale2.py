            ...
            for for_scale in range(SCALE_ALL):
                ...
                for for_1 in range(test_per_sample):
                    ...
                    if for_scale == 1:
                        ...
                        set_z_test = np_utils.to_categorical(z_test[select_sep1:select_sep2], OVERLAP_NUMBER)
            ...
            for for_img in range(images.shape[0]):
                if for_scale == 1:
                    ...
                    ins_predict_to_html.convert_on_RGB_label_overlap_predict2 \
                        (images[for_img], labels[for_img], overlaps[for_img], predict_depth[0], depths2[for_img],
