...
if args.scale1:
    ...
    scale1_base_weights_path = None
# scale2 weight path
if args.scale2:
    scale2_base_weights_pat = path_the_directory + 'weights/' + args.scale2
    print("scale2 weights path\t{}".format(scale2_base_weights_pat))
else:
    scale2_base_weights_pat = None
# limit
if args.limit:
